...
INSERT INTO `line_user` (`email`, `password`, `display`) VALUES 
('master@storyline.co', '1234567890', 'No user');
...
CREATE TABLE `line_chapter` (
	...
	`stor_id` int(11) not null,
	`ordering` DECIMAL(9,6) not null default '0',
	`title` varchar(255) not null,
	`created_at` timestamp not null default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP,
	`updated_at` timestamp not null default '0000-00-00 00:00:00',
	PRIMARY KEY (`chap_id`),
...
CREATE TABLE `line_paragraph` (
	...
	`ordering` DECIMAL(12,9) not null default '0',
	`content` text,
	`created_at` timestamp not null default CURRENT_TIMESTAMP on update CURRENT_TIMESTAMP,
	`updated_at` timestamp not null default '0000-00-00 00:00:00',
	PRIMARY KEY (`para_id`),
...
INSERT INTO sppt_status (title, description) VALUES ('Merged', 'This contribution has been merged into the paragraph.');
INSERT INTO sppt_status (title, description) VALUES ('Retired', 'This contribution will not be merged into the paragraph.');
...
CREATE TABLE `line_contribution` (
	...
	`updated_at` timestamp not null default '0000-00-00 00:00:00',
	PRIMARY KEY (`cont_id`),
	FOREIGN KEY (para_id) REFERENCES line_paragraph(para_id) ON UPDATE CASCADE,
	FOREIGN KEY (user_id) REFERENCES line_user(user_id) ON UPDATE CASCADE,
	FOREIGN KEY (status) REFERENCES sppt_status(status) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;
...
CREATE TABLE `line_contribution_part` (
	...
	FOREIGN KEY (edited_by) REFERENCES line_user(user_id) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;
